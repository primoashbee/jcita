...
<template>
    <div style="min-height:100vh; background:#0a0a0a; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:48px 24px;">
        ...
        <div style="width:100%; max-width:400px; background:#171717; border:1px solid #262626; border-radius:20px; padding:32px;">
            ...
            <button
                type="button"
                style="width:100%; display:flex; align-items:center; justify-content:center; gap:10px; padding:12px; background:#1877F2; border:1px solid #1877F2; border-radius:12px; color:#fff; font-size:14px; font-weight:600; cursor:pointer; margin-bottom:20px;"
